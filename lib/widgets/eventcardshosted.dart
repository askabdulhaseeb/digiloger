...
class EventCardHosted extends StatefulWidget {
  const EventCardHosted({Key? key}) : super(key: key);
  @override
  _EventCardHostedState createState() => _EventCardHostedState();
}

class _EventCardHostedState extends State<EventCardHosted> {
  @override
  void initState() {
    super.initState();
  }
